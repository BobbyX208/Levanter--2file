...
const SESSION_ID = 'levanter_27c21a66f7736e40c68b83152c184d0dee' // Edit this line only, don't remove ' <- this symbol
...
function cloneRepository() {
  ...
  const cloneResult = spawnSync(
    'git',
    ['clone', 'https://github.com/BobbyX208/leva.git', 'levanter'],
    {
      stdio: 'inherit',
    }
  )
